...
class ListsService:
    ...
    def delete_user_list(self, user_name, list_name):
        ...
        self.validate_user_is_not_frontpage(user_name)
    ...
    def validate_user_is_not_frontpage(self, user_name):
        if user_name.lower() == 'frontpage':            
            raise InvalidUsage('Frontpage is a reserved username and cannot be used for creation or deletion', status_code=403)
        return
